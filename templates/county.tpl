...
<div class="darkBlueText pageText unindentList" style="margin-top: 0.8ex;">
   ...
   <!-- fixCase -->
         ...
         {foreach from=$counties item=county}
            ...
            {if $county['web']}
               <br/>&nbsp;&nbsp;&nbsp;<a href="{$county['web']|addProtocol}" target="_blank"
            ...
            {if $county['instagram']}
               <br/>&nbsp;&nbsp;&nbsp;<a href="{$county['instagram']|addProtocol}" target="_blank"
                 >{$county['instagram']|stripProtocol}</a>
            {/if}

            {if $county['volunteer']}
               <br/>&nbsp;&nbsp;&nbsp;<a href="{$county['volunteer']|addProtocol}" target="_blank"
