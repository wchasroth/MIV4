   ...
   <div class="panel" id='disability'>
          <ul>
                <li>Voters with print disabilities can 
                   <a href="https://mi.omniballot.us/sites/26/absentee/app/home" target="_blank"
                ...
                <li><a href="https://mvic.sos.state.mi.us/Home/AccessibleVoting" target="_blank" >Learn more about accessible voting</a>.
                </li>
          </ul>
  </div>
